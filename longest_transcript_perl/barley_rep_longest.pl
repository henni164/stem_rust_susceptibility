...
# barley_rep_longest.pl

# This script will take a barley peptide fasta file and determine and retain only the longest peptide for each locus in the output file

# Cory Hirsch / Erin Gilbert
# January 8, 2018
