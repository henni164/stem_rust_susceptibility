...
setwd("/Users/evahenningsen/Documents/GitHub/cory/MPGI/figure2/GO_SLIM")
...
b2dpiUP = read.csv("filtered_DE_bd21-3_2dpi_0.05_1_up_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
b2dpiUP = unique(b2dpiUP$GID)
b4dpiUP = read.csv("filtered_DE_bd21-3_4dpi_0.05_1_up_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
b4dpiUP = unique(b4dpiUP$GID)
b6dpiUP = read.csv("filtered_DE_bd21-3_6dpi_0.05_1_up_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
b6dpiUP = unique(b6dpiUP$GID)

b2dpiDOWN = read.csv("filtered_DE_bd21-3_2dpi_0.05_1_down_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
b2dpiDOWN = unique(b2dpiDOWN$GID)
b4dpiDOWN = read.csv("filtered_DE_bd21-3_4dpi_0.05_1_down_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
b4dpiDOWN = unique(b4dpiDOWN$GID)
b6dpiDOWN = read.csv("filtered_DE_bd21-3_6dpi_0.05_1_down_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
b6dpiDOWN = unique(b6dpiDOWN$GID)

## W2691 6 comparisons
w2dpiUP = read.csv("filtered_DE_w2691_2dpi_0.05_1_up_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
w2dpiUP = unique(w2dpiUP$GID)
w4dpiUP = read.csv("filtered_DE_w2691_4dpi_0.05_1_up_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
w4dpiUP = unique(w4dpiUP$GID)
w6dpiUP = read.csv("filtered_DE_w2691_6dpi_0.05_1_up_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
w6dpiUP = unique(w6dpiUP$GID)

w2dpiDOWN = read.csv("filtered_DE_w2691_2dpi_0.05_1_down_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
w2dpiDOWN = unique(w2dpiDOWN$GID)
w4dpiDOWN = read.csv("filtered_DE_w2691_4dpi_0.05_1_down_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
w4dpiDOWN = unique(w4dpiDOWN$GID)
w6dpiDOWN = read.csv("filtered_DE_w2691_6dpi_0.05_1_down_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
w6dpiDOWN = unique(w6dpiDOWN$GID)

## Sr9b 6 comparisons
s2dpiUP = read.csv("filtered_DE_sr9b_2dpi_0.05_1_up_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
s2dpiUP = unique(s2dpiUP$GID)
s4dpiUP = read.csv("filtered_DE_sr9b_4dpi_0.05_1_up_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
s4dpiUP = unique(s4dpiUP$GID)
s6dpiUP = read.csv("filtered_DE_sr9b_6dpi_0.05_1_up_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
s6dpiUP = unique(s6dpiUP$GID)

s2dpiDOWN = read.csv("filtered_DE_sr9b_2dpi_0.05_1_down_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
s2dpiDOWN = unique(s2dpiDOWN$GID)
s4dpiDOWN = read.csv("filtered_DE_sr9b_4dpi_0.05_1_down_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
s4dpiDOWN = unique(s4dpiDOWN$GID)
s6dpiDOWN = read.csv("filtered_DE_sr9b_6dpi_0.05_1_down_names_GOSLIM_fixed2.csv", sep="\t", header=TRUE)
    ...
    print(i)
        for(j in exp) {
            ...
            for(k in ont) {
                ...
                write(print(n), file="/Users/evahenningsen/Documents/GitHub/cory/MPGI/figure2/GO_SLIM/GOenrichment_output.txt", sep="\t", append=TRUE)
                write.table(as.data.frame(m), file="/Users/evahenningsen/Documents/GitHub/cory/MPGI/figure2/GO_SLIM/GOenrichment_output.txt", sep="\t", append=TRUE)
            }
        }
}
